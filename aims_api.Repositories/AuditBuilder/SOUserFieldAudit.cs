...
{
    internal class SOUserFieldAudit
    {
        public async Task<AuditTrailModel> BuildTranAuditADD(string fieldName, string createdBy)
        {
            ...
            tempData.Add("Remarks", "SO user field created.");
        ...
        public async Task<AuditTrailModel> BuildTranAuditMOD(string oldFieldName, string newFieldName, string modifiedBy)
        {
            ...
            tempData.Add("Remarks", "SO user field renamed.");
        ...
        public async Task<AuditTrailModel> BuildTranAuditDEL(string fieldName, string userAccountId)
        {
            ...
            tempData.Add("Remarks", "SO user field deleted.");
        ...
        public async Task<AuditTrailModel> BuildTranAuditADDDyn(string sku, string createdBy, dynamic prodUFeilds)
        {
            string actTyp = "ADD";
            string tranTyp = "CONFIG";
        ...
        public async Task<AuditTrailModel> BuildTranAuditMODDyn(string sku, string modifiedBy, dynamic prodUFeilds)
        {
            string actTyp = "MOD";
            string tranTyp = "CONFIG";
            string data = JsonSerializer.Serialize(prodUFeilds);
