...
{
    internal class POUserFieldAudit
    {
        public async Task<AuditTrailModel> BuildTranAuditADD(string fieldName, string createdBy)
        {
            ...
            tempData.Add("Remarks", "PO user field created.");
        ...
        public async Task<AuditTrailModel> BuildTranAuditMOD(string oldFieldName, string newFieldName, string modifiedBy)
        {
            ...
            tempData.Add("Remarks", "PO user field renamed.");
        ...
        public async Task<AuditTrailModel> BuildTranAuditDEL(string fieldName, string userAccountId)
        {
            ...
            tempData.Add("Remarks", "PO user field deleted.");
        ...
        public async Task<AuditTrailModel> BuildTranAuditADDDyn(string poId, string createdBy, dynamic prodUFeilds)
        {
            string actTyp = "ADD";
            string tranTyp = "CONFIG";
            ...
            return await Task.Run(() => {
                return new AuditTrailModel()
                {
                    ...
                    ActionTypeId = actTyp,
                    TransactionTypeId = tranTyp,
                    RecordId = $"{poId} - UserFields",
                    Data = data
                };
            });
        }

        public async Task<AuditTrailModel> BuildTranAuditMODDyn(string poId, string modifiedBy, dynamic prodUFeilds)
        {
            string actTyp = "MOD";
            string tranTyp = "CONFIG";
            string data = JsonSerializer.Serialize(prodUFeilds);
        ...
        public async Task<AuditTrailModel> BuildTranAuditDEL(string poId, string userAccountId, dynamic prodUFeilds)
        {
            string actTyp = "DEL";
            string tranTyp = "CONFIG";
            string data = JsonSerializer.Serialize(prodUFeilds);
