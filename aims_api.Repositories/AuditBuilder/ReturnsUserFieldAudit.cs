...
{
    internal class ReturnsUserFieldAudit
    {
        public async Task<AuditTrailModel> BuildTranAuditADD(string fieldName, string createdBy)
        {
            ...
            tempData.Add("Remarks", "Returns user field created.");
        ...
        public async Task<AuditTrailModel> BuildTranAuditMOD(string oldFieldName, string newFieldName, string modifiedBy)
        {
            ...
            tempData.Add("Remarks", "Returns user field renamed.");
        ...
        public async Task<AuditTrailModel> BuildTranAuditDEL(string fieldName, string userAccountId)
        {
            ...
            tempData.Add("Remarks", "Returns user field deleted.");
        ...
        public async Task<AuditTrailModel> BuildTranAuditADDDyn(string returnsId, string createdBy, dynamic prodUFeilds)
        {
            string actTyp = "ADD";
            string tranTyp = "CONFIG";
            ...
            return await Task.Run(() => {
                return new AuditTrailModel()
                {
                    ...
                    ActionTypeId = actTyp,
                    TransactionTypeId = tranTyp,
                    RecordId = $"{returnsId} - UserFields",
                    Data = data
                };
            });
        }

        public async Task<AuditTrailModel> BuildTranAuditMODDyn(string returnsId, string modifiedBy, dynamic prodUFeilds)
        {
            string actTyp = "MOD";
            string tranTyp = "CONFIG";
            string data = JsonSerializer.Serialize(prodUFeilds);
        ...
        public async Task<AuditTrailModel> BuildTranAuditDEL(string sku, string userAccountId, dynamic prodUFeilds)
        {
            string actTyp = "DEL";
            string tranTyp = "CONFIG";
            string data = JsonSerializer.Serialize(prodUFeilds);
